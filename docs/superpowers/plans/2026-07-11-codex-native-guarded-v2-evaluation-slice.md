...
- Worker-authored text that would violate the renderer's false-clean or worker-assurance claim rules is rejected at reviewer/verifier acceptance and independently by Store before persistence. A terminal completion is never committed first and rejected later solely because accepted worker text is not renderable.
